...
export const A_0603WAF270JT5E = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			pinLabels={pinLabels}
			supplierPartNumbers={{
			...
			manufacturerPartNumber="A_0603WAF270JT5E"
			footprint={
				<footprint>
					<smtpad
						portHints={["pin2"]}
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C25190.obj?uuid=6bd5cd867e9542ebae21caaf5d2d4c4d",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C25190.step?uuid=6bd5cd867e9542ebae21caaf5d2d4c4d",
