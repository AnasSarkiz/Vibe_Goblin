...
export const CC0603JRNPO9BN330 = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			pinLabels={pinLabels}
			supplierPartNumbers={{
			...
			manufacturerPartNumber="CC0603JRNPO9BN330"
			footprint={
				<footprint>
					<smtpad
						portHints={["pin2"]}
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C107047.obj?uuid=ac9b32e974bc448eab36b1293f859dcb",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C107047.step?uuid=ac9b32e974bc448eab36b1293f859dcb",
				pcbRotationOffset: 0,
