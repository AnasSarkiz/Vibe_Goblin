...
export const USBLC6_2SC6 = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C2827654.obj?uuid=229b69761e2c45dba6a83d8866dec72d",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C2827654.step?uuid=229b69761e2c45dba6a83d8866dec72d",
