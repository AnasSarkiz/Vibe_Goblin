...
export const A_0603WAF5101T5E = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			pinLabels={pinLabels}
			supplierPartNumbers={{
			...
			manufacturerPartNumber="A_0603WAF5101T5E"
			footprint={
				<footprint>
					<smtpad
						portHints={["pin2"]}
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C23186.obj?uuid=6bd5cd867e9542ebae21caaf5d2d4c4d",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C23186.step?uuid=6bd5cd867e9542ebae21caaf5d2d4c4d",
