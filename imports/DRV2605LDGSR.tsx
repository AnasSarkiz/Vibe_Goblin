...
export const DRV2605LDGSR = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C527464.obj?uuid=854098f5cce54b6caab82164a7d3deef",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C527464.step?uuid=854098f5cce54b6caab82164a7d3deef",
